...
// @Component
public class ODataEntityProcessor implements EntityProcessor, MediaEntityProcessor {
    ...
    public ODataEntityProcessor(ODataStorage storage) {
    ...
    public void readMediaEntity(ODataRequest request, ODataResponse response, UriInfo uriInfo,
        ...
        if (firstResoucePart instanceof UriResourceEntitySet) {
            final EdmEntitySet edmEntitySet = ODataUtil.getEdmEntitySet(uriInfo);
    ...
    public void deleteMediaEntity(ODataRequest request, ODataResponse response, UriInfo uriInfo)
        ...
        /*
         * In this tutorial, the content of the media entity is stored in a special
         * property.
         * So no additional steps to delete the content of the media entity are
         * necessary.
         * 
         * A real service may store the content on the file system. So we have to take
         * care to
         * delete external files too.
         * 
         * DELETE request to /Advertisments(ID) will be dispatched to the
         * deleteEntity(...) method
         * DELETE request to /Advertisments(ID)/$value will be dispatched to the
         * deleteMediaEntity(...) method
         * 
